...
inline int testConv1DCase0()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 1, 2, 0, true, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 16, 22 };
...
inline int testConv1DCase2()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 1, 3, 0, true, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 22, 31 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
...
inline int testConv1DCase3()
{
    ...
    qint32_t R_data[] = { 6, 12, 6, 12, 6, 12 };
...
inline int testConv1DCase4()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 3, 3, 0, true, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase5()
{
    ...
    Conv1D<qint32_t> layer{ 1, 3, 2, 2, 0, false, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
...
inline int testConv1DCase8()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 3, 2, 0, true, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase10()
{
    ...
    Conv1D<qint32_t> layer{ 1, 3, 3, 2, 0, true, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase11()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 3, 3, 0, false, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
...
inline int testConv1DCase12()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 1, 2, 0, true, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase13()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 2, 3, 0, false, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
...
inline int testConv1DCase15()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 1, 3, 0, false, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
...
inline int testConv1DCase16()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 2, 3, 0, true, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 4, 10 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
...
inline int testConv1DCase17()
{
    ...
    Conv1D<qint32_t> layer{ 1, 3, 2, 1, 0, false, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
...
inline int testConv1DCase19()
{
    ...
    Conv1D<qint32_t> layer{ 1, 3, 2, 3, 0, false, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 3, 9, 3, 9, 3, 9 };
	Tensor<qint32_t> R{ 3, 1, 2 };
	R.allocateCustom(R_data, 6);
...
inline int testConv1DCase20()
{
    ...
    Conv1D<qint32_t> layer{ 1, 3, 1, 1, 0, true, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 2, 3, 4, 5, 6, 2, 3, 4, 5, 6, 2, 3, 4, 5, 6 };
	Tensor<qint32_t> R{ 3, 1, 5 };
	R.allocateCustom(R_data, 15);
...
inline int testConv1DCase21()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 1, 3, 0, false, PaddingMode::REFLECT };
    Fill(layer.weights, 1);
...
inline int testConv1DCase22()
{
    ...
    Conv1D<qint32_t> layer{ 1, 3, 3, 3, 0, true, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 7, 16, 7, 16, 7, 16 };
	Tensor<qint32_t> R{ 3, 1, 2 };
	R.allocateCustom(R_data, 6);
...
inline int testConv1DCase24()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 1, 3, 0, true, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase29()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 3, 3, 0, false, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 6, 15 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
...
inline int testConv1DCase30()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 3, 3, 0, true, PaddingMode::REFLECT };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase32()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 1, 3, 0, true, PaddingMode::REFLECT };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 19, 28 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
...
inline int testConv1DCase35()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 2, 1, 0, false, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
    
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 45, 51, 57, 63, 69 };
	Tensor<qint32_t> R{ 1, 1, 5 };
	R.allocateCustom(R_data, 5);
...
inline int testConv1DCase36()
{
    ...
    Conv1D<qint32_t> layer{ 1, 3, 2, 3, 0, true, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase37()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 1, 2, 0, false, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
...
inline int testConv1DCase46()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 3, 3, 0, true, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 7, 16 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
...
inline int testConv1DCase52()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 2, 3, 0, true, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase55()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 2, 2, 0, false, PaddingMode::ZEROS };
    Fill(layer.weights, 1);
    
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 33, 45 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
...
inline int testConv1DCase56()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 3, 3, 0, true, PaddingMode::REFLECT };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase57()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 1, 3, 0, false, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
...
inline int testConv1DCase58()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 1, 1, 0, true, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 2, 3, 4, 5, 6, 7 };
...
inline int testConv1DCase60()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 3, 3, 0, true, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase65()
{
    ...
    qint32_t R_data[] = { 3, 7, 11, 3, 7, 11, 3, 7, 11 };
	Tensor<qint32_t> R{ 3, 1, 3 };
	R.allocateCustom(R_data, 9);
...
inline int testConv1DCase66()
{
    ...
    Conv1D<qint32_t> layer{ 1, 1, 3, 2, 0, true, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);
...
inline int testConv1DCase73()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 2, 3, 0, false, PaddingMode::CIRCULAR };
    Fill(layer.weights, 1);
    
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 39, 57 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
...
inline int testConv1DCase74()
{
    ...
    Conv1D<qint32_t> layer{ 3, 1, 1, 3, 0, true, PaddingMode::REPLICATE };
    Fill(layer.weights, 1);
    Fill(layer.biases, 1);
    const auto out = layer.forward(A);

    qint32_t R_data[] = { 16, 25 };
	Tensor<qint32_t> R{ 1, 1, 2 };
	R.allocateCustom(R_data, 2);
