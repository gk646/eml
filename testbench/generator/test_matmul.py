...
def impl_gen_matmul(A_shape, B_shape, transpose_A=False, transpose_B=False):
    ...
    A_tensor_decl = gen_utils.generate_decl_tensor_range("A", A_shape)
...
A_shapes = [(10, 10), (3, 5), (5, 3), (8, 8)]  # Square and non-square matrices
B_shapes =  [(10, 10), (3, 5), (5, 3), (8, 8)]  # Compatible shapes for each A
